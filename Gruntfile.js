module.exports = function(grunt) {
  ...
  grunt.initConfig({
   ...
   clean: {
      ...
      stylesheets: {
        src: [ 'build/**/*.css', 'build/css/**', '!build/stylesheet.min.css', '!build/bootstrap-3.3.4-dist/**' ]
      },
      scripts: {
        src: [ 'build/**/*.js', 'build/js/**', '!build/javascript.min.js', '!build/bootstrap-3.3.4-dist/**' ]
      }
    },
    ...
    cssmin: {
      build: {
        files: {
          'build/stylesheet.min.css': [ 'build/**/*.css', '!build/bootstrap-3.3.4-dist/**' ]
        }
      }
    },
